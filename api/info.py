...
class handler(BaseHTTPRequestHandler):
  ...
  def do_GET(self):
    ...
    registrationPageContent = session.get("https://home-access.cfisd.net/HomeAccess/Content/Student/Registration.aspx").text
    ...
    try:
      ...
      schedulePageContent = session.get("https://home-access.cfisd.net/HomeAccess/Content/Student/Classes.aspx")
